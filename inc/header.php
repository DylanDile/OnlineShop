...
<body>
  <div class="wrap">
		<div class="header_top">
			<div class="logo">
				<a href="index.php"><img src="images/gtel-logo.jpg" alt="" /></a>
			</div>
...
?>
		 ...
		 <div>
		 	<br>
		 	<br>
		 	<h2 style="font-style: italic; font-weight: bold; font-size: 30px; color: orange; float: center; "> The best Shop for all your Smart Gadgets</h2>
		 	<img src="images/newlogo.png" width="20%" height="20%" style="float: right; border-radius: 50%; margin-top: 0%; ">
		 </div>
	 </div>
	 <div class="clear"></div>
 </div>
